...
(1, 170, 'Calle de la Piruleta, 2', 'Madrid', 1, 1),
(2, 180, 'Calle Mendoza, 56', 'Madrid', 0, 2),
(3, 190, 'Avenida Pintor Sorolla, 125 4ºG', 'Madrid', 1, 3),
(4, 200, 'Calle de la Princesa, 8 4ºC', 'Madrid', 0, 4),
(5, 200, 'Calle Altamirano, 8 4ºC', 'Madrid', 1, 5);
...
(20, 6, 1, 2, 13, 1, '2019-06-17', 1),
(21, 1, 1, 1, NULL, 0, '2019-06-17', 1),
(22, 1, 1, 3, NULL, 0, '2019-05-20', 1),
(23, 1, 3, 2, NULL, 0, '2019-05-21', 1),
(24, 2, 1, 3, NULL, 0, '2019-05-21', 1),
(25, 6, 5, 1, NULL, 0, '2019-06-20', 1),
(26, 7, 5, 5, NULL, 0, '2019-06-19', 1),
(27, 7, 5, 7, NULL, 0, '2019-06-20', 1);
...
(10, 'TestAdmin', '81dc9bdb52d04dc20036dbd8313ed055', 'TestAdmin', 'fsdffd', '72104925V', 666666666, 'inescnunez@gmail.com', '2019-06-15', 'EMPLEADO'),
(11, 'TestCli', '81dc9bdb52d04dc20036dbd8313ed055', 'Test', 'Test', '72104925V', 680128680, 'test@correo.es', '1998-04-22', 'CLIENTE'),
(12, 'TestEmple', 'e10adc3949ba59abbe56e057f20f883e', 'TestEmpleado', 'TestEmpleado', '72104925V', 680128680, 'inescnunez@gmail.com', '2019-06-02', 'EMPLEADO');
...
--
ALTER TABLE `casa`
  MODIFY `P_casa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `empleado_cliente_tarea`
  MODIFY `P_empleadoSalaTarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `usuario`
  MODIFY `P_Usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
